...
final class MysteryInCasablancaMusicService {
    static let shared = MysteryInCasablancaMusicService()
    ...
    func startAudio() {
        activateSession()
        guard let sound = Bundle.main.path(forResource: "mystery-in-casablanca", ofType: "mp3"),
